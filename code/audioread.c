...
//declaration of wav_data local 
    double* wav_data;


//printf("begin audioread\n");
 // open file
 ...
 // if (ptr!=NULL)
 // {
 //    printf("on a bien lu le fichier\n");
 // }
 ...
 if (header.format_type == 1) { // PCM
            ...
            for (i =0; i < num_samples; i++) {
                ...
                if (read == 1) {
                    ...
                    for (xchannels = 0; xchannels < header.channels; xchannels ++ ) {
                        ...
                        //On  recupere les valeurs des donnees dans le tableau wave_data
    ...
    // cleanup before quittingfor (int i=0; i <num_samples; ++i) {

    //printf("end audioread\n");
    return wav_data;
